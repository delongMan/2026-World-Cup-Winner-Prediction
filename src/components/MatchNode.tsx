...
export const MatchPair = memo(function MatchPair({ match, team1, team2, isComplete, onTeamClick, bp }: P) {
  ...
  return (
    <motion.div ref={setNodeRef} data-match-id={match.id}
      ...
      className={`flex-shrink-0 transition-all duration-300 ease-out overflow-hidden
        ${isOver && canInteract ? 'rounded-2xl ring-2 ring-accent-gold bg-accent-gold/8 scale-[1.04] z-50 shadow-xl'
